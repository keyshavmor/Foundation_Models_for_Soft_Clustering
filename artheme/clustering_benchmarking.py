...
if "X_pca_scGPT" in bench_cfg['embedding_keys']:
    ...
    adata.obsm['X_pca_scGPT'] = adata.obsm['X_pca']
    del adata.obsm['X_pca']
    print(f"PCA calculated and stored in adata.obsm['X_pca_scGPT']")
...
adata.write_h5ad('midpoint_sn_sn_3000.h5ad', compression='gzip')
...
if not bench_cfg['run_benchmark']:
    ...
    if not embedding_keys:
        ...
        results_table_path = output_cfg['benchmarking_output_dir']
